    ...
    <div className="min-h-screen" style={{ backgroundColor: '#F5EDE3' }}>
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs" style={{ color: '#C4956A' }}>Suburb Search</p>
            </div>
          </Link>
          <Link href="/" className="text-sm font-semibold" style={{ color: '#C4956A' }}>
            ← Home
          </Link>
        </div>
      </header>
      ...
      <main className="max-w-5xl mx-auto px-4 py-10">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-black mb-2" style={{ color: '#2C1A0E' }}>What should I buy in…</h2>
        ...
        <div className={`grid gap-6 ${result ? 'lg:grid-cols-[420px_1fr]' : 'max-w-xl mx-auto'}`}>
          ...
          <div className="rounded-2xl shadow-xl p-7 h-fit lg:sticky lg:top-24"
            ...
            <div className="flex items-center gap-2 mb-5">
              ...
              <h3 className="text-base font-bold" style={{ color: '#2C1A0E' }}>Suburb Brief</h3>
            </div>
            ...
            <div>
              ...
              {loading && !result && (
                <div className="rounded-2xl p-8 text-center"
                  ...
                  <p className="text-sm font-semibold" style={{ color: '#2C1A0E' }}>Researching the suburb…</p>
                  <p className="text-xs mt-1" style={{ color: '#8B5E3C' }}>Checking medians, growth drivers, demographics</p>
                </div>
              )}
        ...
        {!result && !loading && !error && (
          <div className="mt-10 text-center" style={{ color: '#A07850' }}>
